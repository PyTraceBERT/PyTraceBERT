...
from model.models import PyTraceBertForClassification
...
def parse_args():
    ...
    # args.add_argument("-trainset", "--trainset", type=str,
    #                   default="./dataset/task/sample/upsample/split_ratio_622/train_and_gpt.csv",
    #                   help="fine_tuning data directory")
    #
    # args.add_argument("-validset", "--validset", type=str,
    #                   default="./dataset/task/split_ratio_622/valid.csv", help="fine_tuning data directory")
    #
    # args.add_argument("-testset", "--testset", type=str,
    #                   default="./dataset/task/split_ratio_622/test.csv", help="fine_tuning data directory")

    args.add_argument("-outfolder", "--outfolder", type=str,
                      default=f"./output/pytracebert/kfold_fine_tuning/", help="Folder name to save the models.")

    args.add_argument("-pretrained_model_path", "--pretrained_model_path", type=str,
                      default=f"./pretrained/pytracebert/model/", help="pretrained model")
...
def train(MODEL='pytracebert', augmentation=True):
    ...
    for fold in range(len(train_folds)):
        ...
        model = PyTraceBertForClassification.from_pretrained(args.pretrained_model_path, num_labels=2)
...
if __name__ == '__main__':
    ...
    args = parse_args()
    # model = ''
    # args.outfolder = f"./output/kfold_fine_tuning/{model}/"
